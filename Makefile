...
SRC = $(TARGET).c glcd/glcd.c glcd/devices/AVR8.c glcd/controllers/PCD8544.c glcd/graphs.c glcd/text.c glcd/graphics.c glcd/unit_tests.c glcd/text_tiny.c grn_24C512.c grn_TWI.c
